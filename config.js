...
global.mongodb = process.env.MONGODB_URI || "mongodb+srv://astrolegendfx:astro@cluster0.tjtnbim.mongodb.net/"
...
module.exports = {
  ...
  author: process.env.PACK_INFO && process.env.PACK_INFO.split(";")[0] ? process.env.PACK_INFO.split(";")[0] : 'SamPandey001',
  packname: process.env.PACK_INFO && process.env.PACK_INFO.split(";")[1] ? process.env.PACK_INFO.split(";")[1] : 'Secktor-Md',
